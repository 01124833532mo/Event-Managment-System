...
{
    public class SettedOrganizerIdInterseptor : AuditInterceptor
    {
        private readonly ILoggedInUserService _loggedInUserService;

        public SettedOrganizerIdInterseptor(ILoggedInUserService loggedInUserService) : base(loggedInUserService)
        {
        ...
        private new void UpdateEntities(DbContext? context)
        {
            ...
            var Entries = context.ChangeTracker.Entries<IBaseOrganzer>()
            ...
            foreach (var entry in Entries)
            {
                ...
                if (entry.State is EntityState.Added)
                {
                    ...
                    entry.Entity.OrganizerId = _loggedInUserService.UserId;
